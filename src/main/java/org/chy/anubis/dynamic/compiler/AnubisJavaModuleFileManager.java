 ...
 * 支持模块化管理的
 */
public class AnubisJavaModuleFileManager implements JavaFileManager {
    ...
    public boolean hasLocation(Location location) {
       ...
       /* if ("MODULE_SOURCE_PATH".equals(location.getName())) {
            return false;
        }

        if ("PATCH_MODULE_PATH".equals(location.getName())) {
            return false;
        }
        if ("ANNOTATION_PROCESSOR_MODULE_PATH".equals(location.getName())) {
            return false;
        }
        return true;*/
    }
