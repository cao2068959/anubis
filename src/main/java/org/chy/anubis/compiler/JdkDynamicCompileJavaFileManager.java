...
public class JdkDynamicCompileJavaFileManager extends ForwardingJavaFileManager<JavaFileManager> {
    ...
    @Getter
    private CharSequenceJavaFileObject javaFileObject;

    public JdkDynamicCompileJavaFileManager(JavaFileManager fileManager) {
        super(fileManager);
    }
    ...
    public JavaFileObject getJavaFileForOutput(Location location, String className, JavaFileObject.Kind kind, FileObject sibling) throws IOException {
        this.javaFileObject = new CharSequenceJavaFileObject(className, kind);
